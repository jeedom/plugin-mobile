...
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/FLOOD_1.jpg[width=300,align="center"]|-Inondation
...
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/LOCK_1.jpg[width=300,align="center"]|-Serrure Etat
...
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/SIREN_1.jpg[width=300,align="center"]|-Sirène Etat
...
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/FLOOD_1.jpg[width=300,align="center"]|-Fumée
...
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/TEMPERATURE_1.jpg[width=300,align="center"]|-Temperature
...
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/PRESENCE_1.jpg[width=300,align="center"]|-Précence
...
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/OPENNING_1.jpg[width=300,align="center"]|-Porte / Fenêtre
...
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/HEATING_1.jpg[width=300,align="center"]|-Chauffage fil pilote Bouton ON
...
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/ACTION_1.jpg[width=300,align="center"]|-Generic (action)|-GENERIC_ACTION|Le bouton prend la forme du type de l'action, si defaut alors c'est un toggle, si message, alors vous avez une enveloppe, si slider vous avez un slider etc..
|=======================

.Generique Info
|=======================
|Image|type générique attendu|Partie Dev plugin tiers|Description
|image:../images/INFO_1.jpg[width=300,align="center"]|-Generic (info)|-GENERIC_INFO|Le bouton prend la forme du type de l'info.
|=======================
