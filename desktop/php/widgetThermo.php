...
<div id='container'>
	...
	<div id='controls'>
		...
		<label><span style="color:#94CA02;">Temperature</span>
              <input class="testDiv slider_bar" id='input_target_temperature' type="range" min="0" max="100" step="1"  data-cmd_id="">
		</label>

			<label><span style="color:#94CA02;">Ambient Temperature</span>
         <input class="testDiv slider_bar" id='input_ambient_temperature' type="range" min="0" max="100" step="1" data-cmd_id="">
		</label>
