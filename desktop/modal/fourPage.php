...
<div class="test" style="display:flex;flex-direction:column;width:100%;height:100%;margin-bottom:5%;margin-top:2%;align-items:center;">
  ...
  <p style="font-weight:bold;font-size:16px;color:#94CA02;">Pour acceder aux fonctionnalités comme les Notifications, la Personnalisation du Menu ou la Geolocalisation, il faut au préalable avoir selectionné au moins une box 'actuelle'</p>
