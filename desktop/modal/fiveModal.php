...
<div class="test" style="display:flex;flex-direction:column;width:100%;height:100%;margin-bottom:5%;margin-top:2%;align-items:center;">
  ...
  <p style="font-weight:bold;">{{Fonctionnement de la Géolocalisation}}</p>
  ...
  <div style="display:flex;width:100%;height:100%;padding-top:0;margin-top:2%;">
    ...
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;width:25%;text-align:center;">
      ...
      <p style="font-weight:bold">{{Si vous vous trouvé dans la zone à sa création, elle passera en vert après quelques secondes}}</p>
    </div>
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;width:25%;text-align:center;">
      <p style="font-weight:bold">{{Modifier largueur de la zone}}</p>
    </div>
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;width:25%;text-align:center;">
      <p style="font-weight:bold">{{Ajouter une zone ajoutera dans votre équipement téléphone dans le plugin Mobile une commande binaire, qui pourra vous servir à programmer des actions en fonction de son état.}}</p>
    </div>
  </div>
