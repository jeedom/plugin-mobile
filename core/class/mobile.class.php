...
class mobile extends eqLogic {
	...
	public static function dependancy_install() {
		...
		self::generate_file();
		return array('script' => dirname(__FILE__) . '/../../resources/install_homebridge.sh '.network::getNetworkAccess('internal','ip'), 'log' => log::getPathToLog(__CLASS__ . '_homebridge_update'));
	}
